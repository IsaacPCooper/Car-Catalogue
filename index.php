...
<html>
	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header">
				<div class="content">
					<h1><a href="#">Jordan PC Austin</a></h1>
					<p>Social Media<br /></p>
					<ul class="actions">
						<li><a href="https://goo.gl/MFzYRr" class="button icon fa-linkedin">LinkedIn</a> </li>
						<li><a href="https://goo.gl/CfvB8Y" class="button icon fa-twitter">Twitter</a> </li>
						<li><a href="https://goo.gl/nj4Vuz" class="button icon fa-github">Github</a></li>
					</ul>
					<br/>
				</div>
				<div class="image"><div class="inner"><img width=250 height=250 src="images/Screen.png" alt="" /></div></div>
			</header>
